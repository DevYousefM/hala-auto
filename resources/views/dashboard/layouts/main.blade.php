            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header d-flex justify-items-between items-center">
                        <h5 class="modal-title" id="exampleModalLabel">{{ __('site.change_password') }}</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="#">
                            <div class="mb-3">
                                <label for="recipient-name" class="col-form-label">{{ __('site.new_password') }}</label>
                                <input type="password" class="form-control" id="new-password" name="password">
                            </div>
                            <div class="mb-3">
                                <button class="btn btn-primary">{{ __('site.change') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
